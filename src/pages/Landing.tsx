...
export default function Landing() {
  ...
  return (
    <div style={{ background: '#0a0603', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      {/* ─── HERO ────────────────────────────────────────── */}
      <section style={{ minHeight: '100vh', position: 'relative', overflow: 'hidden', background: '#0a0603', display: 'flex', alignItems: 'center' }}>
        ...
        >
          ...
          />
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, #0a0603 0%, rgba(10,6,3,0.5) 30%, transparent 65%)' }} />
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '35%', background: 'linear-gradient(to bottom, transparent, #0a0603)' }} />
        </motion.div>
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 200, background: 'linear-gradient(to bottom, transparent, #0a0603)', zIndex: 3, pointerEvents: 'none' }} />
      </section>

      {/* ─── STATS TICKER ────────────────────────────────── */}
      <div style={{ overflow: 'hidden', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '14px 0', background: 'rgba(10,6,3,0.95)' }}>
      ...
      {/* ─── MODULES ─────────────────────────────────────── */}
      <section id="modules" style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(60px,10vw,120px) clamp(20px,4vw,48px)', background: '#0a0603' }}>
      ...
      {/* ─── STATS ROW ───────────────────────────────────── */}
      <div style={{ padding: '80px clamp(20px,4vw,48px)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(10,6,3,0.98)' }}>
        ...
        <div style={{ display: 'flex', width: `${hPanels.length * 100}vw`, height: '100vh' }}>
          {hPanels.map((panel, i) => (
            <div
              key={i}
              className="h-panel"
              style={{ width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', background: '#0a0603' }}
            >
      ...
      {/* ─── BLOB DIVIDER ────────────────────────────────── */}
      <div style={{ position: 'relative', height: 240, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0603' }}>
      ...
      {/* ─── NEWS SECTION ────────────────────────────────── */}
      <section id="news" style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(60px,10vw,100px) clamp(20px,4vw,48px)', background: '#0a0603' }}>
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto' }}>
      ...
      {/* ─── EXTENSION SECTION ───────────────────────────── */}
      <section id="extension" style={{ padding: 'clamp(60px,10vw,100px) clamp(20px,4vw,48px)', borderTop: '1px solid rgba(255,255,255,0.05)', background: 'rgba(10,6,3,0.98)' }}>
      ...
      {/* ─── REVIEWS ─────────────────────────────────────── */}
      <section id="reviews" style={{ padding: 'clamp(60px,8vw,100px) 0 clamp(60px,8vw,100px) clamp(20px,4vw,48px)', overflow: 'hidden', background: '#0a0603' }}>
        <motion.div {...IN_VIEW} style={{ maxWidth: 1200, marginBottom: 56 }}>
          ...
          >
            <img
              ...
              style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top', display: 'block' }}
            />
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '40%', background: 'linear-gradient(to bottom, transparent, #0a0603)' }} />
          </motion.div>
      ...
      {/* ─── FINAL CTA ───────────────────────────────────── */}
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', background: '#0a0603' }}>
      ...
      {/* ─── FOOTER ──────────────────────────────────────── */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '32px clamp(20px,4vw,48px)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(10,6,3,0.98)', flexWrap: 'wrap', gap: 20 }}>
