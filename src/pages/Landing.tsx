  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{ minHeight: '100vh', position: 'relative', overflow: 'hidden', background: '#000', display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            maskImage: 'linear-gradient(to top, transparent 5%, rgba(0,0,0,0.35) 60%, transparent 100%)',
            WebkitMaskImage: 'linear-gradient(to top, transparent 5%, rgba(0,0,0,0.35) 60%, transparent 100%)',
          }} />
        </div>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(60px,10vw,100px) clamp(20px,4vw,48px)', background: '#000', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        {/* Perspective danger grid */}
        <div style={{ position: 'absolute', bottom: 0, left: '-10%', right: '-10%', height: '55%', pointerEvents: 'none',
          backgroundImage: 'linear-gradient(rgba(255,45,45,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(255,45,45,0.04) 1px, transparent 1px)',
          backgroundSize: '50px 50px',
          transform: 'perspective(600px) rotateX(-50deg)',
          transformOrigin: 'bottom center',
          maskImage: 'linear-gradient(to top, transparent 10%, rgba(0,0,0,0.4) 70%, transparent 100%)',
          WebkitMaskImage: 'linear-gradient(to top, transparent 10%, rgba(0,0,0,0.4) 70%, transparent 100%)',
          zIndex: 0,
        }} />
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 60, alignItems: 'center' }}>
            ...
            <motion.div {...IN_VIEW} style={{ flex: '1 1 300px' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 16, maxWidth: 500, lineHeight: 1.65, marginBottom: 36 }}>
                Check any email against 12+ billion leaked credentials. D0B3RMAN searches across thousands of known data breaches — banks, social networks, healthcare, gaming — and tells you exactly where your data was exposed and what to do next.
              </p>
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 36 }}>
                {['12B+ leaked records', '600+ breach sources', 'Instant verdict'].map((feat) => (
                  <span key={feat} style={{ padding: '8px 14px', background: 'rgba(255,45,45,0.06)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,45,45,0.18)', borderRadius: 8, fontFamily: 'JetBrains Mono', fontSize: 11, color: 'rgba(255,80,80,0.8)' }}>
                    {feat}
                  </span>
                ))}
              </div>
            ...
            <motion.div
              {...IN_VIEW}
              className="glass"
              style={{ flex: '1 1 300px', padding: 32, borderRadius: 24, position: 'relative', overflow: 'hidden', minHeight: 380 }}
            >
              <div style={{ marginBottom: 20 }}>
                <p style={{ fontFamily: 'JetBrains Mono', fontSize: 10, letterSpacing: '0.2em', color: 'var(--danger)', marginBottom: 8 }}>BREACH REPORT</p>
                <p style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 28, color: 'var(--danger)', lineHeight: 1 }}>7 breaches found</p>
                <p style={{ fontFamily: 'JetBrains Mono', fontSize: 11, color: 'rgba(255,255,255,0.25)', marginTop: 6 }}>for ██████@email.com</p>
              </div>
              ...
              {[
                ...
                <div key={breach.name} style={{ padding: '10px 14px', background: 'rgba(255,45,45,0.05)', border: '1px solid rgba(255,45,45,0.14)', borderRadius: 10, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{ fontFamily: 'JetBrains Mono', fontSize: 10, color: 'rgba(255,149,0,0.7)', whiteSpace: 'nowrap' }}>{breach.records}</span>
                </div>
              ))}
      ...
      {/* ─── STATS ROW ───────────────────────────────────── */}
      <div style={{ padding: '80px clamp(20px,4vw,48px)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(6,6,6,0.98)', position: 'relative', overflow: 'hidden' }}>
        {/* Stats dot grid */}
