...
import { Eye, Shield, Brain, Newspaper, ArrowRight, Clock } from 'lucide-react'
...
export default function Dashboard() {
  ...
  const moduleCards = [
    ...
    { to: '/breach', icon: Shield, name: 'BREACH', sub: 'Data Breach Scanner', desc: 'Check if your credentials have been leaked in public data breaches.', count: stats.breachToday, limit: 3, src: '/assets/video/5550b5f21861539de2d6c651cf6bbb1f.jpg', isImage: true, label: 'BREACH -- DATA BREACH SCANNER' },
    ...
    { to: '/news', icon: Newspaper, name: 'NEWS', sub: 'Verify + Feed', desc: 'Verify headlines and browse live cybersecurity news from top sources.', count: stats.newsToday, limit: 3, src: '/assets/video/cdd8c26722152919a8539f357363c238.jpg', isImage: true, label: 'NEWS -- VERIFY + FEED' },
  ]
    ...
    <Layout profile={profile} onSignOut={signOut} title="Dashboard">
      <div style={{ padding: 'clamp(16px, 4vw, 32px)', maxWidth: 1200, margin: '0 auto', overflowX: 'hidden' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12, marginBottom: 40 }}>
          {[
            { label: 'Scans Today', value: stats.eyesToday + stats.newsToday + stats.breachToday, color: 'var(--chrome-mid)' },
            { label: 'Threats Found', value: stats.threatsDetected, color: 'var(--danger)' },
            { label: 'AI Messages', value: stats.brainToday, color: 'var(--safe)' },
            { label: 'Total Scans', value: stats.eyesTotal + stats.brainTotal, color: 'var(--warning)' },
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        {item.type === 'eyes' && item.score !== undefined && !item.result && (
