      ...
      <div style={{ padding: 'clamp(16px, 4vw, 40px)', maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
            ...
            />
            <p style={{ fontFamily: 'JetBrains Mono', fontSize: 10, letterSpacing: '0.25em', color: 'var(--ovw-0p25)', textTransform: 'uppercase' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginBottom: 40 }}>
            {[
              ...
              <span key={label} style={{ fontFamily: 'JetBrains Mono', fontSize: 10, letterSpacing: '0.1em', color: 'var(--ovw-0p5)', background: 'var(--ovw-0p05)', border: '1px solid var(--ovw-0p1)', padding: '5px 12px', borderRadius: 6 }}>
                {label}
              </span>
            ))}
          </div>
        ...
        <motion.div {...IN_VIEW} style={{ marginBottom: 32 }}>
          <p style={{ fontFamily: 'JetBrains Mono', fontSize: 11, letterSpacing: '0.15em', color: 'var(--ovw-0p3)', marginBottom: 16, textTransform: 'uppercase' }}>
            Platform Highlights
          </p>
        ...
        <motion.div {...IN_VIEW} style={{ marginBottom: 40 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {REPORT.chapters.map((ch, i) => {
              ...
              const color = chapterColors[i] || 'var(--ovw-0p6)'
              return (
                <motion.button
                  key={ch.number}
                  ...
                  viewport={{ once: true }}
                  whileHover={{ x: 4, borderColor: 'var(--ovw-0p16)' }}
                  onClick={() => navigate('/report/full')}
                  className="glass"
                ...
                >
                  ...
                  <ArrowRight size={14} style={{ color: 'var(--ovw-0p2)', flexShrink: 0 }} />
                </motion.button>
              )
            })}
          </div>
